...
- 力扣中国站给《剑指 Offer》系列单独分配的编号前缀，与主站 1~3000+ 编号**互不相干**：LCR 165 ≠ 165. 比较版本号。
- 官方题单：https://leetcode.cn/problem-list/G25w0aD1/
- 题目文件用 `LCR 编号.标题.cpp` 命名放在本目录（`lcof/`），主题库的题放 `leetcode/`。

共 194 题：LCR 001–119（专项突击版，119 题）+ LCR 120–194（第 2 版，75 题）。

## 标签分布（题数）

数组(84)、字符串(44)、动态规划(36)、哈希表(36)、深度优先搜索(36)、树(30)、二叉树(30)、广度优先搜索(28)、数学(25)、双指针(20)、链表(20)、设计(18)、排序(17)、二分查找(16)、栈(16)、回溯(13)、位运算(12)、递归(12)、滑动窗口(10)、矩阵(10)、分治(10)、图(10)、二叉搜索树(9)、堆（优先队列）(9)、前缀和(7)、并查集(7)、队列(6)、字典树(6)、模拟(5)、单调栈(4)、数据流(4)、拓扑排序(4)、双向链表(3)、有序集合(3)、计数(3)、快速选择(3)、归并排序(3)、记忆化(3)、贪心(2)、随机化(2)、桶排序(2)、线段树(2)、单调队列(2)、迭代器(1)、计数排序(1)、组合数学(1)、最短路(1)、树状数组(1)、枚举(1)、概率与统计(1)、脑筋急转弯(1)

# 一、《剑指 Offer（专项突击版）》LCR 001 – 119

对应早年站内编号「剑指 Offer II 001 ~ 119」。
...
# 二、《剑指 Offer（第 2 版）》LCR 120 – 194

对应早年站内编号「剑指 Offer 03 ~ 68」。这批题在站上被换过标题包装（如「把数字翻译成字符串」改叫「解密数字」），URL slug 末尾仍保留 `-lcof`，可据此判断它原本属于第 2 版。
